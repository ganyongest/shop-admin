...
public interface UserService {
    ...
    ServerResponse sendCode(String phone,HttpServletRequest request,HttpServletResponse response);

    ServerResponse updatePassword(User user, String code, HttpServletRequest request,HttpServletResponse response);
}
